...
const Skill = ({directionLeft} : Props) => {
  return (
    ...
    group-hover:bg-white h-24 w-24 md:w-28 md:h-28 xl:w-32 xl:h-32 z-0 rounded-full'>
        <div className='flex items-center justify-center h-full '>
            <p className='text-3xl font-bold text-black placeholder-\opacity-100'>100%</p>
        </div>
    </div>
    </div>
  )
